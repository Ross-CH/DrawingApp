...
public class RecordObjectMovementV04 : MonoBehaviour
{
    ...
    void RedrawLine()
    {
        ...
        //Access the object script that runs it's draw animation
        var RedrawLineScript = CurrentLineObject.GetComponent<LineBehaviourV01>();
...
//______________________Update all the verts with the new position
